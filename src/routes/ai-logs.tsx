...
const teammates = [
  ...
  ["Emeka Nwosu", "TA & Merchant Growth", "Owns terminal recovery prioritisation and merchant growth insight."],
  ["Zainab Aliyu", "SME Lending", "Owns selective, responsible lending opportunities."],
  ["Tunde Bakare", "Audit & Verification", "Owns source-of-truth reconciliation and evidence states."],
] as const;
    ...
    <div className="mx-auto max-w-6xl space-y-6">
      <section>
        ...
        <p className="mt-2 max-w-3xl text-sm leading-6 text-muted-foreground">
          The four teammates will share one operational truth model. Phase 1 establishes identities and an audit ledger;
          agent reasoning and automation are connected later rather than being faked in the interface.
        </p>
      </section>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Accountability is designed into the data model before automation begins.</CardDescription>
        </CardHeader>
        <CardContent className="grid gap-3 md:grid-cols-2">
          <AuditItem label="Actor" detail="Director, assistant, system, Amina, Emeka, Zainab or Tunde" />
          <AuditItem label="Timestamp" detail="Every event records when it occurred" />
          <AuditItem label="Entity" detail="Task, terminal, merchant, report or verification record" />
      ...
      <div className="flex gap-3 rounded-lg border bg-card p-4 text-sm leading-6 text-muted-foreground">
        ...
        <p>
          AI teammates do not own independent copies of merchant truth. They will operate over the same secured database,
          with Tunde's verification outcomes kept separate from human claims and AI recommendations.
        </p>
      </div>
    </div>
  );
